...
def index():
    ...
    for p in perfis:
        ...
        <div class="canal-item canal-manual">
    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .canal-item { background: #0d0d14; border: 1px solid var(--border); padding: 8px; border-radius: 6px; text-align: center; cursor: pointer; font-size: 0.8em; text-transform: uppercase; transition: 0.2s; position: relative; }
            .canal-item:hover { background: var(--accent); border-color: var(--accent); }
            .canal-manual { background: #1a1a2e; border-color: var(--accent); }
            .canal-nome { cursor: pointer; }
            .btn-del-canal { background: var(--danger); padding: 4px 8px; border-radius: 4px; font-size: 0.7em; margin-top: 5px; cursor: pointer; }
        </style>
    </head>
    <body>
        <div class="container">
